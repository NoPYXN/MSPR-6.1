...
const SignupSchema = Yup.object().shape({
  ...
  password: Yup.string().min(8, 'Le mot de passe doit contenir au moins 8 caractères').required('Champ obligatoire'),
  confirmPassword: Yup.string()
    .oneOf([Yup.ref('password'), null], 'Les mots de passe doivent correspondre')
    .required('Champ obligatoire'),
  phoneNumber: Yup.string().matches(/^[0-9]+$/, "Doit être uniquement des chiffres").required('Champ obligatoire'),
